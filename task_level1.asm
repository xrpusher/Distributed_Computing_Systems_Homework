...
; Стандартная сложность: Два таймера выводят строки через USART
;===========================================================
...
; Константы
;===========================================================
.equ F_CPU = 16000000           ; Тактовая частота 16 МГц (Arduino Uno)
.equ BAUD = 9600                ; Скорость UART
.equ UBRR_VALUE = ((F_CPU/(16*BAUD))-1)

; Интервалы для таймеров
; Пример: Timer1_INTERVAL = 62500 дает примерно 1 секунду при прескалере 256 и 16 МГц
.equ TIMER1_INTERVAL = 62500    
; Timer2_INTERVAL = 250 с прескалером 1024 дает около 16 мс
...
pong_str: .db "pong\r\n",0
;===========================================================
; Векторы прерываний для ATmega8
;===========================================================
.cseg
.org 0x0000
